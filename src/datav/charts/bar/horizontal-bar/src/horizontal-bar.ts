...
export class HorizontalBarSeries extends DatavChartSeries {
 ...
 * HorizontalBar
 */
export class HorizontalBar extends DatavEChartsComponent {
	config = {
		global: {
		...
		series: [new HorizontalBarSeries("系列1")],
		animation: {
			enabled: true,
			duration: 1000,
			easing: "cubicOut",
	...
	constructor() {
		super("HorizontalBar", { w: 500, h: 300 });
