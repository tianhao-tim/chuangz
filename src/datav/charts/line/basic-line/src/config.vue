	...
	<div class="setting-panel-gui">
		<g-field-collapse label="全局">
			...
			<g-field :level="2" label="连接空数据">
				<el-switch v-model="config.global.connectNulls" />
			</g-field>
		</g-field-collapse>
		<g-field-collapse v-model="config.xAxis.show" :toggle="true" label="X轴">
			...
			<g-field :level="2" label="两端留白">
				<el-switch v-model="config.xAxis.boundaryGap" />
			</g-field>
			<g-field-collapse v-model="config.xAxis.title.show" :toggle="true" label="轴标题">
				...
				<g-field :level="2" label="展示方式" :is-flat="true">
					<g-input-number v-model="config.xAxis.title.display.rotate" :min="0" :max="360" :step="1" suffix="度" inline="inline" label="旋转" />
					<g-input-number v-model="config.xAxis.title.display.offset" :min="-1000" :max="1000" :step="1" suffix="px" inline="inline" label="偏移" />
				</g-field>
				<g-field :level="2" label="文本样式" :is-flat="true">
					<g-input-number v-model="config.xAxis.title.textStyle.fontSize" :min="12" :max="100" :step="1" suffix="px" inline="inline" label="字号" />
			...
			<g-field-collapse v-model="config.xAxis.axisLabel.show" :toggle="true" label="轴标签">
				...
				<g-field :level="2" tooltip="默认会采用标签不重叠的策略间隔显示标签，可以设置成 0 强制显示所有标签。" label="间隔">
					<g-select-suggest v-model="config.xAxis.axisLabel.interval" :data="selectSuggests" :filters="['auto', '0', '1', '2']" />
				</g-field>
				<g-field :level="2" label="展示方式" :is-flat="true">
					<g-input-number v-model="config.xAxis.axisLabel.display.rotate" :min="0" :max="360" :step="1" suffix="度" inline="inline" label="旋转" />
					<g-input-number
				...
				<g-field :level="2" label="文本样式" :is-flat="true">
					...
					<g-select v-model="config.xAxis.axisLabel.textStyle.fontWeight" :data="fontWeights" inline="inline" label="字体粗细" />
				</g-field>
			</g-field-collapse>
			<g-field-collapse v-model="config.xAxis.grid.show" :toggle="true" label="网格线">
				<g-field :level="2" label="线型样式" :is-flat="true">
					...
					<g-input-number v-model="config.xAxis.grid.line.width" :min="0" :max="100" :step="1" suffix="px" inline="inline" label="粗细" />
					<g-color-picker v-model="config.xAxis.grid.line.color" inline="inline-single" label="颜色" />
					<g-input-number v-model="config.xAxis.grid.line.dashedLength" :min="0" :max="100" :step="1" suffix="px" inline="inline" label="长度" />
					<g-input-number v-model="config.xAxis.grid.line.dashedSpace" :min="0" :max="100" :step="1" suffix="px" inline="inline" label="间隔" />
				</g-field>
			</g-field-collapse>
		</g-field-collapse>
		<g-field-collapse v-model="config.yAxis.show" :toggle="true" label="Y轴">
			...
			<g-field-collapse v-model="config.yAxis.title.show" :toggle="true" label="轴标题">
				...
				<g-field :level="2" label="展示方式" :is-flat="true">
					<g-input-number v-model="config.yAxis.title.display.rotate" :min="0" :max="360" :step="1" suffix="度" inline="inline" label="旋转" />
					<g-input-number v-model="config.yAxis.title.display.offset" :min="-1000" :max="1000" :step="1" suffix="px" inline="inline" label="偏移" />
				</g-field>
				<g-field :level="2" label="文本样式" :is-flat="true">
					<g-input-number v-model="config.yAxis.title.textStyle.fontSize" :min="12" :max="100" :step="1" suffix="px" inline="inline" label="字号" />
			...
			<g-field-collapse v-model="config.yAxis.axisLabel.show" :toggle="true" label="轴标签">
				...
				<g-field :level="2" label="展示方式" :is-flat="true">
					<g-input-number v-model="config.yAxis.axisLabel.display.rotate" :min="0" :max="360" :step="1" suffix="度" inline="inline" label="旋转" />
					<g-input-number
				...
				<g-field :level="2" label="文本样式" :is-flat="true">
					...
					<g-select v-model="config.yAxis.axisLabel.textStyle.fontWeight" :data="fontWeights" inline="inline" label="字体粗细" />
				</g-field>
			</g-field-collapse>
			<g-field-collapse v-model="config.yAxis.grid.show" :toggle="true" label="网格线">
				<g-field :level="2" label="线型样式" :is-flat="true">
					...
					<g-input-number v-model="config.yAxis.grid.line.width" :min="0" :max="100" :step="1" suffix="px" inline="inline" label="粗细" />
		...
		<g-field-collapse v-model="config.tooltip.show" :toggle="true" label="提示框">
			<g-field :level="2" label="触发方式">
				<el-radio-group v-model="config.tooltip.triggerOn" size="small">
					<el-radio-button
						v-for="pair in [
		...
		<g-field-collapse v-model="config.legend.show" :toggle="true" label="图例">
			...
			<g-field :level="2" label="布局方式">
				<el-radio-group v-model="config.legend.orient" size="small">
					<el-radio-button v-for="em in orients" :key="em.id" :value="em.id">
						{{ em.value }}
					</el-radio-button>
				</el-radio-group>
			</g-field>
		...
		>
			<template #default="slotProps">
				<g-field :level="2" label="折线" :is-flat="true">
					...
					<g-input-number v-model="slotProps.item.line.width" :min="0" :max="100" :step="1" suffix="px" inline="inline-single" label="粗细" />
					<g-slider v-model="slotProps.item.line.opacity" :min="0" :max="1" :step="0.01" inline="inline" label="透明度" />
					<g-slider v-model="slotProps.item.line.smooth" :min="0" :max="1" :step="0.1" inline="inline-single" label="曲线平滑程度" />
				</g-field>
				<g-field :level="2" label="标记" :is-flat="true">
					...
					<g-input-number v-model="slotProps.item.point.borderWidth" :min="0" :max="100" :step="1" suffix="px" inline="inline" label="描边粗细" />
				...
				<g-field-collapse v-model="slotProps.item.label.show" :toggle="true" label="标注">
					...
					<g-field :level="2" label="相对偏移" :is-flat="true">
						<g-input-number v-model="slotProps.item.label.offset.x" :min="-1000" :max="1000" :step="1" suffix="px" inline="inline" label="水平" />
						<g-input-number v-model="slotProps.item.label.offset.y" :min="-1000" :max="1000" :step="1" suffix="px" inline="inline" label="垂直" />
					</g-field>
					...
					<g-field :level="2" label="文本样式" :is-flat="true">
						...
						<g-select v-model="slotProps.item.label.textStyle.fontWeight" :data="fontWeights" inline="inline-single" label="字体粗细" />
					</g-field>
					<g-field :level="2" label="描边" :is-flat="true">
						<g-color-picker v-model="slotProps.item.label.stroke.color" inline="inline" label="颜色" />
						<g-input-number v-model="slotProps.item.label.stroke.width" :min="0" :max="100" :step="1" suffix="px" inline="inline" label="粗细" />
					</g-field>
				</g-field-collapse>
			</template>
		</g-field-collapse>
