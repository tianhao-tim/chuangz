<template>
	<div class="setting-panel-gui">
		<g-field-collapse label="全局">
			...
			<g-field label="圆角">
				<g-input-number v-model="config.global.borderRadius" :min="0" :max="300" :step="1" suffix="px" />
			</g-field>
			...
			<g-field label="南丁格尔图">
				<div class="pt-5">
					<el-switch v-model="config.global.roseType" size="small" />
				</div>
			</g-field>
		</g-field-collapse>
...
import { BasicRing } from "./basic-ring";

const props = defineProps({
	com: {
		type: Object as PropType<BasicRing>,
		required: true
	}
});
