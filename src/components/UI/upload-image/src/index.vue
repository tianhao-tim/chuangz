<template>
	...
	>
		<el-input type="text" :model-value="modelValue" placeholder="请输入图片地址" size="small" @update:model-value="handleInput" />
		<el-upload
			v-loading="loading"
...
import { uploadHost, validAllowImg } from "@/utils/uploadUtil";
...
export default defineComponent({
	...
	setup(props, ctx) {
		...
		const onSuccess = (res: any) => {
			loading.value = false;
			ctx.emit(UPDATE_MODEL_EVENT, res.data);
		};
